...
import com.wipro.doconnect.image.repository.ImageModelRepo;
...
public class UserServiceImpl implements UserService {
	...
	public Question askQuestion(AskQuestionDTO askQuestionDTO) {
		...
		// a mail should go to the admin that a question is published
		List<Admin> admins = adminRepo.findAll();
		for (Admin admin : admins) {
			sendMail(admin.getEmail(), "A new Question has been Added please review");
		}
	...
	public Answer giveAnswer(@Valid PostAnswerDTO postAnswerDTO) {
		...
		List<Admin> admins = adminRepo.findAll();
		for (Admin admin : admins) {
			sendMail(admin.getEmail(), "A new Answer has been Added please review");
		}
